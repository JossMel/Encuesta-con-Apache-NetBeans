...
import modelosDAO.GraficaDAO;

/**
 *
 * @author JosselynMartinez
 */
@WebServlet(name = "ControllerGrafrico", urlPatterns = {"/ControllerGrafrico"})
public class ControllerGrafrico extends HttpServlet {
        ...
        dispatcher.forward(request,response);
         ...
         //try ( PrintWriter out = response.getWriter()) {
           ...
           //  for(encuesta enc1 : consulta1 ){
             //    out.print(enc1.getCantidad());
             //}
         //}   
        /*if(consulta1 == null){
            request.setAttribute ("consulta1",consulta1);
            RequestDispatcher dispatcher = request.getRequestDispatcher("grafico.jsp");
            dispatcher.forward(request,response);c
        }*/
